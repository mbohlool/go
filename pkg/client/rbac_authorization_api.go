...
type RbacAuthorizationApi struct {
	Configuration *Configuration
}

func NewRbacAuthorizationApi() *RbacAuthorizationApi {
...
func NewRbacAuthorizationApiWithBasePath(basePath string) *RbacAuthorizationApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a RbacAuthorizationApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/rbac.authorization.k8s.io/"
