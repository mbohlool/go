...
type ApiregistrationApi struct {
	Configuration *Configuration
}

func NewApiregistrationApi() *ApiregistrationApi {
...
func NewApiregistrationApiWithBasePath(basePath string) *ApiregistrationApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a ApiregistrationApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/apiregistration.k8s.io/"
