...
type Storage_v1Api struct {
	Configuration *Configuration
}

func NewStorage_v1Api() *Storage_v1Api {
...
func NewStorage_v1ApiWithBasePath(basePath string) *Storage_v1Api {
	configuration := NewConfiguration()
 ...
 */
func (a Storage_v1Api) CreateStorageClass(body V1StorageClass, pretty string) (*V1StorageClass, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1/storageclasses"
	...
	var successPayload = new(V1StorageClass)
 ...
 * @return *V1Status
 */
func (a Storage_v1Api) DeleteCollectionStorageClass(pretty string, continue_ string, fieldSelector string, includeUninitialized bool, labelSelector string, limit int32, resourceVersion string, timeoutSeconds int32, watch bool) (*V1Status, *APIResponse, error) {
 ...
 * @return *V1Status
 */
func (a Storage_v1Api) DeleteStorageClass(name string, body V1DeleteOptions, pretty string, gracePeriodSeconds int32, orphanDependents bool, propagationPolicy string) (*V1Status, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Delete")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1/storageclasses/{name}"
 ...
 */
func (a Storage_v1Api) GetAPIResources() (*V1ApiResourceList, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1/"
 ...
 */
func (a Storage_v1Api) ListStorageClass(pretty string, continue_ string, fieldSelector string, includeUninitialized bool, labelSelector string, limit int32, resourceVersion string, timeoutSeconds int32, watch bool) (*V1StorageClassList, *APIResponse, error) {
	...
	var successPayload = new(V1StorageClassList)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
 ...
 * @return *V1StorageClass
 */
func (a Storage_v1Api) PatchStorageClass(name string, body interface{}, pretty string) (*V1StorageClass, *APIResponse, error) {
 ...
 * @return *V1StorageClass
 */
func (a Storage_v1Api) ReadStorageClass(name string, pretty string, exact bool, export bool) (*V1StorageClass, *APIResponse, error) {
 ...
 * @return *V1StorageClass
 */
func (a Storage_v1Api) ReplaceStorageClass(name string, body V1StorageClass, pretty string) (*V1StorageClass, *APIResponse, error) {
