...
func NewSchedulingApi() *SchedulingApi {
...
func NewSchedulingApiWithBasePath(basePath string) *SchedulingApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a SchedulingApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/scheduling.k8s.io/"
