...
func NewStorageApiWithBasePath(basePath string) *StorageApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a StorageApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/"
