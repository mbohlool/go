...
type Authentication_v1beta1Api struct {
	Configuration *Configuration
}

func NewAuthentication_v1beta1Api() *Authentication_v1beta1Api {
...
func NewAuthentication_v1beta1ApiWithBasePath(basePath string) *Authentication_v1beta1Api {
	configuration := NewConfiguration()
 ...
 */
func (a Authentication_v1beta1Api) CreateTokenReview(body V1beta1TokenReview, pretty string) (*V1beta1TokenReview, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/authentication.k8s.io/v1beta1/tokenreviews"
	...
	var successPayload = new(V1beta1TokenReview)
 ...
 */
func (a Authentication_v1beta1Api) GetAPIResources() (*V1ApiResourceList, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/authentication.k8s.io/v1beta1/"
