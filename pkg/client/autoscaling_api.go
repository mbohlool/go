...
func NewAutoscalingApi() *AutoscalingApi {
...
func NewAutoscalingApiWithBasePath(basePath string) *AutoscalingApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a AutoscalingApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/autoscaling/"
