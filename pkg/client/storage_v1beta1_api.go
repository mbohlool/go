...
type Storage_v1beta1Api struct {
	Configuration *Configuration
}

func NewStorage_v1beta1Api() *Storage_v1beta1Api {
...
func NewStorage_v1beta1ApiWithBasePath(basePath string) *Storage_v1beta1Api {
	configuration := NewConfiguration()
 ...
 */
func (a Storage_v1beta1Api) CreateStorageClass(body V1beta1StorageClass, pretty string) (*V1beta1StorageClass, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1beta1/storageclasses"
	...
	var successPayload = new(V1beta1StorageClass)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "CreateStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
 ...
 * @return *V1Status
 */
func (a Storage_v1beta1Api) DeleteCollectionStorageClass(pretty string, continue_ string, fieldSelector string, includeUninitialized bool, labelSelector string, limit int32, resourceVersion string, timeoutSeconds int32, watch bool) (*V1Status, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeleteCollectionStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *V1Status
 */
func (a Storage_v1beta1Api) DeleteStorageClass(name string, body V1DeleteOptions, pretty string, gracePeriodSeconds int32, orphanDependents bool, propagationPolicy string) (*V1Status, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Delete")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1beta1/storageclasses/{name}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeleteStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 */
func (a Storage_v1beta1Api) GetAPIResources() (*V1ApiResourceList, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/storage.k8s.io/v1beta1/"
 ...
 */
func (a Storage_v1beta1Api) ListStorageClass(pretty string, continue_ string, fieldSelector string, includeUninitialized bool, labelSelector string, limit int32, resourceVersion string, timeoutSeconds int32, watch bool) (*V1beta1StorageClassList, *APIResponse, error) {
	...
	var successPayload = new(V1beta1StorageClassList)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ListStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *V1beta1StorageClass
 */
func (a Storage_v1beta1Api) PatchStorageClass(name string, body interface{}, pretty string) (*V1beta1StorageClass, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PatchStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *V1beta1StorageClass
 */
func (a Storage_v1beta1Api) ReadStorageClass(name string, pretty string, exact bool, export bool) (*V1beta1StorageClass, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ReadStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *V1beta1StorageClass
 */
func (a Storage_v1beta1Api) ReplaceStorageClass(name string, body V1beta1StorageClass, pretty string) (*V1beta1StorageClass, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ReplaceStorageClass", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
