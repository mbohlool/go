...
> V2beta1HorizontalPodAutoscalerList ListNamespacedHorizontalPodAutoscaler($namespace, $pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
