...
> V1Status DeleteCollectionNamespacedNetworkPolicy($namespace, $pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
...
> V1NetworkPolicyList ListNamespacedNetworkPolicy($namespace, $pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
...
> V1NetworkPolicyList ListNetworkPolicyForAllNamespaces($continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $pretty, $resourceVersion, $timeoutSeconds, $watch)
