...
> V1Status DeleteCollectionNamespacedPodDisruptionBudget($namespace, $pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
...
> V1beta1PodDisruptionBudgetList ListNamespacedPodDisruptionBudget($namespace, $pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
...
> V1beta1PodDisruptionBudgetList ListPodDisruptionBudgetForAllNamespaces($continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $pretty, $resourceVersion, $timeoutSeconds, $watch)
