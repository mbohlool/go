...
> V1Status DeleteCollectionStorageClass($pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
...
# **ListStorageClass**
> V1beta1StorageClassList ListStorageClass($pretty, $continue_, $fieldSelector, $includeUninitialized, $labelSelector, $limit, $resourceVersion, $timeoutSeconds, $watch)
