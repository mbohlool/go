...
type ApiextensionsApi struct {
	Configuration *Configuration
}

func NewApiextensionsApi() *ApiextensionsApi {
...
func NewApiextensionsApiWithBasePath(basePath string) *ApiextensionsApi {
	configuration := NewConfiguration()
 ...
 * @return *V1ApiGroup
 */
func (a ApiextensionsApi) GetAPIGroup() (*V1ApiGroup, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/apis/apiextensions.k8s.io/"
